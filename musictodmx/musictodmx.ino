...
void taskFire(void *pvParameters) {
  ...
  while (true) {
    ...
    if(distance>100 || distance == 0){
      ...
      Serial.println((String)"durata = " + (micros()-startTime));
...
void setup(){
    ...
    xTaskCreate(taskFire, "fireStart", 90, NULL, 3, &taskFireHandle);
...
void loop(){}#if !defined(STM32_CORE_VERSION) || (STM32_CORE_VERSION  < 0x01090000)
#error "Due to API change, this sketch is compatible with STM32_CORE_VERSION  >= 0x01090000"
#endif
